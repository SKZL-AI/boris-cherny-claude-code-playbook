![Tips](https://img.shields.io/badge/Tips-152-blue)
...
> **152 tips from the Head of Claude Code at Anthropic — auto-updated daily.**
...
1. **First complete collection** of all public Boris Cherny tips in one place — 152 tips, 21 themes
...
**Current:** 152 tips across 21 themes, documented over 14 months.
...
- **[TIPS.md](./TIPS.md)** — All 152 tips, structured by theme and difficulty. Source of truth for automation.
...
| 03 | CLAUDE.md | 13 | "Anytime Claude does something wrong, we add it to the CLAUDE.md" |
...
| 07 | Permissions & Safety | 8 | Pre-allow > skip; Sandbox > danger flag |
...
| 10 | Verification | 12 | **The #1 rule: 2–3x quality through verification** |
...
*Maintained by [SKZL-AI](https://github.com/SKZL-AI) · Last full audit: 2026-09-23*
