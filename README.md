![Tips](https://img.shields.io/badge/Tips-143-blue)
...
> **143 tips from the Head of Claude Code at Anthropic — auto-updated daily.**
...
1. **First complete collection** of all public Boris Cherny tips in one place — 143 tips, 21 themes
...
**Current:** 143 tips across 21 themes, documented over 14 months.
...
- **[TIPS.md](./TIPS.md)** — All 143 tips, structured by theme and difficulty. Source of truth for automation.
...
|---|---|---:|---|
| 01 | Parallel Execution | 10 | "The single biggest productivity unlock" |
...
| 09 | Model & Effort | 12 | Opus with Thinking for everything (Boris) |
| 10 | Verification | 11 | **The #1 rule: 2–3x quality through verification** |
| 11 | Long-Running & Recaps | 7 | Routines, Schedules, Stop Hooks |
| 12 | Prompting & Specs | 6 | Delegation > Guidance |
| 13 | Customization | 7 | 37 settings, 84 env variables |
| 14 | Headless / SDK | 11 | Claude as a Unix utility |
| 15 | Code Review | 3 | "Reviews were the bottleneck" |
| 16 | Cost / ROI | 5 | "It's an ROI question, not a cost question" |
| 17 | Form Factor | 7 | CLI, IDE, GitHub, Slack, Mobile, Web |
| 18 | Migration & Data | 3 | Finish what you start |
| 19 | Learning & Onboarding | 5 | Explanatory Output Style |
| 20 | Context Management | 6 | Context rot at 300–400k tokens |
...
*Maintained by [SKZL-AI](https://github.com/SKZL-AI) · Last full audit: 2026-06-11*
